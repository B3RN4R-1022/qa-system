...
const MAC_CMD     = `curl -fsSL https://raw.githubusercontent.com/B3RN4R-1022/qa-system/master/nocorplus-agent/install.sh | bash`
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[480px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl z-50 p-4">
          ...
          <p className="text-[11px] text-gray-400 mt-3 leading-relaxed">
            O instalador baixa o Nocorp+ Agent, instala as dependências e cria o app na área de trabalho. Requer Node.js 18+ e Git.
          </p>
        </div>
      )}
    </div>
